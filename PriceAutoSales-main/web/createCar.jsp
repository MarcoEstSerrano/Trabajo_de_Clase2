                    ...
                    <form action="createCarLogic.jsp">
                        <div class="mb-3">
                            <select name="selBrand" class="form-select" aria-label="Select your brand">
                                ...
                                ResultSet resultset = datos.getBrands();
                                String Marcas;
                                while (resultset.next()){
                                Marcas = resultset.getString("Marca");
                        ...
                        <div class="mb-3">
                            <select name="selModel" class="form-select" aria-label="Select your model">
                                ...
                                <% 
                                databaseHelper datos2 = new databaseHelper();
                                ResultSet resultset2 = datos2.getModels();
                                String NombredeCarros;
                                while (resultset2.next()){
                                NombredeCarros = resultset2.getString("NombredeCarro");
                                  
                                %>
                                <option value="<%= NombredeCarros%>"><%= NombredeCarros%></option>
                                <% } %>
                            </select>  
                        </div>     
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <select name="selFuelType" class="form-select" aria-label="Select your fuel type">
                                ...
                                <% 
                                databaseHelper datos3 = new databaseHelper();
                                ResultSet resultset3 = datos3.getFuelType();
                                String FuelTypes;
                                while (resultset3.next()){
                                FuelTypes = resultset3.getString("Combustible");
                                
                                    
                                %>
                                <option value="<%= FuelTypes%>"><%= FuelTypes%></option>
                                <% } %>                               
                            </select> 
                        </div>   
                        <div class="mb-3">
